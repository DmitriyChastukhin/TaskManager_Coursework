...
public class TodoServer {
    ...
    public void start() throws IOException {
        String jsonRequest;
        List<OperationRequest> allRequests = new ArrayList<>();
        ...
        try (ServerSocket serverSocket = new ServerSocket(port);) {
            while (true) {
                try (
                    ...
                    OperationRequest request = gson.fromJson(jsonRequest, OperationRequest.class);
                    ...
                    switch (request.getType()) {
                        ...
                        case ("RESTORE"):
                            OperationRequest lastRequest = allRequests.get(allRequests.size() - 1);
